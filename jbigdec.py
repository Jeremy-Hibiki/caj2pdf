...
if arch[1] == 'WindowsPE':
    if arch[0] == '64bit':
        libjbigdec = cdll.LoadLibrary(os.path.join(file_path, "./lib/bin/libjbigdec-w64.dll"))
    else:
        libjbigdec = cdll.LoadLibrary(os.path.join(file_path, "./lib/bin/libjbigdec-w32.dll"))
else:
    libjbigdec = cdll.LoadLibrary(os.path.join(file_path, "./libjbigdec.so"))
